...
\author{Vladimir Reinharz$^{1}$, Yann Ponty$^{2}\footnote{To whom correspondence should be addressed}\;$, J\'er\^{o}me Waldisp\"{u}hl$^{1*}$}
\date{$^1$ School of Computer Science \& McGill Centre for Bioinformatics, McGill University, Montr\'eal, Canada H3C 2J7\newline $^2$ CNRS/\'Ecole Polytechnique/Inria AMIB, LIX, Palaiseau, France }
